...
pheno = pheno %>% mutate(AmountC_high = AmountC_elevated - AmountC_ambient, AmountC_low = AmountC_subamb - AmountC_ambient,
                              ...
                              biomass_high = biomass_elevated - biomass_ambient, biomass_low = biomass_subamb - biomass_ambient,
                              ht_flag_high = ht_flag_elevated - ht_flag_ambient, ht_flag_low = ht_flag_subamb - ht_flag_ambient,
                              ht_flower_high = ht_flower_elevated - ht_flower_ambient, ht_flower_low = ht_flower_subamb - ht_flower_ambient,
                              AmountC_high2 = AmountC_elevated - AmountC_subamb, AmountN_high2=AmountN_elevated - AmountN_subamb,
                              CN_high2 = CN_elevated - CN_subamb, d13C_high2 = d13C_elevated - d13C_subamb, 
                              d15N_high2 = d15N_elevated - d15N_subamb, biomass_high2 = biomass_elevated - biomass_subamb,
                              ht_flag_high2 = ht_flag_elevated - ht_flag_subamb, ht_flower_high2 = ht_flower_elevated - ht_flower_subamb )

## pheno for averages across treatments
